...
export class Ball {
        ...
        update(gravity, canvasW, canvasH, others = []) {
                ...
                //Checking Collisions >>>
                if (others.some(ball => this.CheckCollision(ball) && !ball.isDragging)) {
        ...
        getDebugInfo(mouseX, mouseY) {
                return [
                        ...
                        `bottomCollided: ${this.bottomCollided}`
                ];
        }

        CheckCollision(otherBall) { //v is for vertex
                let ballx1 = this.x;
                let bally1 = this.y;
                ...
                //         return true;
                // }
                const xOverlap =  Math.min(ballx2, OBx2) - Math.max(ballx1, OBx1);
                const yOverlap =  Math.min(bally2, OBy2) - Math.max(bally1, OBy1);
                const check_isOverlaped = xOverlap > 0 && yOverlap > 0;
                const check_isCollided = xOverlap == 0 || yOverlap == 0;

                if (check_isOverlaped){
                ...
                else if (!check_isOverlaped && check_isCollided) {
                        this.isOverlapped = false;
                        this.isColliding = true;
                        return true;
                }
        ...
        FindCollisionDir(otherball){ //Push the other ball out of it self
                ...
                if(colliderMid_x == selfMid_x && colliderMid_y != selfMid_y){
                        if (otherball.y < this.y){
                                console.log("Collision Direction: Top");
                                return "Top";
                        }
                        else if(this.y < otherball.y){
                                console.log("Collision Direction: Bottom");
                                return "Bottom";
                        }
                }
                ...
                if(collider_Quadrant == "Left, Top"){
                        ...
                        //Catch corner collision >>>
                                ...
                                console.log("Edge/Corner Collision. Prioritized to Top");
                                return "Top";
                        }
                        ///<<< Catch corner collision
                }
                        ...
                        //Bottom Collision >>>
                        if((otherball.prevX + otherball.size) > this.prevX && otherball.prevY > (this.prevY+this.size)){
                                console.log("Collision Direction: Bottom");
                                return "Bottom";
                        }
                        //<<< Bottom collision
                        //Left Collision >>>
                        else if((otherball.prevX + otherball.size) < this.prevX && otherball.prevY < (this.prevY+this.size)){
                                console.log("Collision Direction: Left");
                                return "Left";
                        }
                        //<<< Left Collision
                        //Catch corner collision >>>
                                ...
                                console.log("Edge/Corner Collision. Prioritized to Bottom");
                                return "Bottom";
                        }
                        //<< Catch corner collision
                }
                        ...
                        //Bottom Collision >>>
                        if(otherball.prevX < (this.prevX+this.size) && otherball.prevY > (this.prevY+this.size)){
                                console.log("Collision Direction: Bottom");
                                return "Bottom";
                        }
                        //<<< Bottom collision
                        //Left Collision >>>
                        else if(otherball.prevX > (this.prevX+this.size) && otherball.prevY < (this.prevY+this.size)){
                                console.log("Collision Direction: Left");
                                return "Right";
                        }
                        //<<< Left Collision
        ...
        isMouseInside(x, y) { //When mouse is clicked, checks if it's clicked on an object
                return (
